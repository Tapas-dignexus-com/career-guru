                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center justify-content-between">
                                <div class="position-relative d-flex gap-3">
                                    ...
                                    <button type="button"
                                        class="btn btn-primary radius-20 ps-2 text-center d-flex align-items-center"><i
                                            class="fadeIn animated bx bx-search-alt"></i>search</button>
                                </div>
                                <div class="d-flex gap-2 ">
                                    <button type="button" class="btn btn-primary radius-20 ps-2 text-center"><i
                                            class="fadeIn animated bx bx-sort"></i>Filter</button>
                                    <!-- <button type="button" class="btn btn-primary radius-20 ps-2 text-center"><i class="fadeIn animated bx bx-check-double"></i>Select All</button> -->
                                    <button type="button" class="btn btn-primary radius-20"><i
                                            class="fadeIn animated bx bx-message-detail"></i>Mail</button>
                                    <button type="button" class="btn btn-primary radius-20"><i
                                            class="fadeIn animated bx bx-message-detail"></i>Messages</button>
                                    <button type="button" class="btn btn-primary radius-20"><i
                                            class="lni lni-download"></i>Download</button>
                                    <button type="button" class="btn btn-primary radius-20"><i
                                            class="lni lni-upload"></i>Upload</button>
                                </div>
                            </div>
                        </div>
                        <div class="breadcrumb-title">Student</div>
                        <div class="">
                            <table class="table " style="width:100% ; border: 1px solid black;">
                                <thead class="table-light border">
                                    <tr>
                                        <th class="border text-center" style="width:20px ;">Id</th>
                                        <th>Photo</th>
                                        <th class="border" style="width:250px ;">Personal details</th>
                                        <th class="border">Date Of Birth</th>
                                        <th class="border"> Interseted Field </th>
                                        <!-- <th class="border" style="width:30px ;">Pin</th> -->
                                        <th class="border" style="width:50px ;">Mobile Number</th>
                                        <!-- <th class="border"style="width:100px ;">Email</th> -->
                                        <th class="border">Balance</th>
                                        <th class="border">View Details</th>
                             ...
                             <tr class="border-2">
                              ...
                              <td class="border "><img src="assets/images/student_photo/sachin-tendulkar-legends.jpg" alt="" style="width:60px ;"></td>
                              <td class="border">
                               <div class="d-flex flex-column">
                                ...
                                <div class="s-address">
                                 19-A, Perry Cross Road, Bandra (West),Mumbai, Maharashtra
                                </div>
                              ...
                              <td>19/12/1999</td>
                                    ...
                                    <tr class="border">
                                        ...
                                        <td class="border "><img
                                                src="assets/images/student_photo/sachin-tendulkar-legends.jpg"
                                                alt="" style="width:60px ;"></td>
                                        <td class="border">
                                            <div class="d-flex flex-column">
                                                <div class="s-name">
                                                    <label for="" class="text-primary"><b> Stu:</b> </label>
                                                    Sachin tendulkar
                                                </div>
                                                <div class="f-name">
                                                    <label for="" class="text-primary"> <b> C/o:</b> </label>
                                                    Ramesh tendulkar
                                                </div>

                                                <div class="s-address">
                                                    <label for="" class="text-primary"><b> Adr:</b> </label>
                                                    19-A, Perry Cross Road, Bandra (West),Mumbai, Maharashtra
                                                </div>

                                                <div class="email">
                                                    <label for="" class="text-primary"><b> Email:</b> </label>
                                                    email@99XXXXXXXX
                                                </div>
                                            </div>
                                        </td>
                                        <td class="border">19/12/1999</td>
                                        <td class="border">
                                            Interseted Field
                                        </td>
                                        <td class="border">99XXXXXXXX</td>
                                        <td class="border">99X</td>
                                        <td class="border">
                                            <div class="d-flex flex-column align-items-center">
                                                <a href="view_record.html"><button type="button"
                                                        class="btn btn-primary  radius-30  mb-3">Details</button></a>
                                                <a href=""><button type="button"
                                                        class="btn btn-primary radius-30 px-3">Offer</button></a>
                                            </div>
                                        </td>
                                        <td class="border">
                              ...
                              <td class="border"><img src="assets/images/student_photo/sachin-tendulkar-legends.jpg" alt="" style="width:50px ;"></td>
                              <td class="border">Sachin tendulkar</td>
                              <td class="border">Ramesh tendulkar</td>
                              <td  class="border" >
                              ...
                              <td class="border"> 400050.</td>
                              <td class="border">99XXXXXXXX</td>
                              <td class="border" style="width:80px ;">email@99XXXXXXXX</td>
                              <td class="border">99X</td>
                              <td class="border"><a href="view_record.html"><button type="button" class="btn btn-primary  radius-30">Details</button></a></td>
                              <td class="border">
                               <div class="d-flex order-actions">
                                <a href="javascript:;" class=""><i class='bx bxs-edit text-success'></i></a>
