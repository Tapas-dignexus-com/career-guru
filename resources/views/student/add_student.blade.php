                    ...
                    <div class="card border-top border-0 border-4 border-info">
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <div class="row mb-3">
                                    <label for="inputConfirmPassword2" class="col-sm-3 col-form-label">PIN</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" id="inputAddress4" rows="3" placeholder="Address" style="resize: none;"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputState" class="form-label">Catagory</label>
                                        <select id="inputState" class="form-select">
                                            <option selected="">Choose...</option>
                                            <option>General</option>
                                            <option>S.C</option>
                                            <option>S.T</option>
                                            <option>O.B.C-A</option>
                                            <option>O.B.C-B</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="inputZip" class="form-label">Qulifaction</label>
                                        <select id="qua" class="form-select" onchange="myFunction()">
                                            <option selected="">Choose...</option>
                                ...
                                <hr>
                                <h5 class="mb-0 text-primary text-center">Field of Instrest</h5>
                                <hr>
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <label class="">ALL
