    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="breadcrumb-title border-0">View/List</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-lg-flex align-items-center gap-3 mb-3">
                            ...
                            <button type="submit" class="rounded-pill px-4 py-1 border-0"
                                style="background-color:#0d6dfdd0; color: #fff; font-weight: bold;">Search</button>
                            <div class="col-sm-5">
                            </div>
                        </div>
                        <div class="">
                            <table class="table " style="width:100% ;">
                                <thead class="table-primary border">
                                    <tr class="border">
                                        <th class="border text-center"style="width:50px;">S/L</th>
                                        <th class="border text-center"style="width:50px;">Code</th>
                                        <th class="border text-center">Topic Name</th>
                                        <th class="border text-center">Subject</th>
                                        <th class="border text-center">Level</th>
                                        <th class="text-center">No Of Question</th>
                                ...
                                <tbody>
                                    <tr class="border">
                                        ...
                                        <td class="border text-center">(Auto)</td>
                                        <td class="border text-center">Topics</td>
                                        <td class="border text-center">Subject name</td>
                                        <td class="border text-center">Easy</td>
                                        <td class="border text-center">50</td>
                                        <td class="text-center"><button type="button"
                                                class="btn btn-primary  radius-30">Details</button></td>
                                        <td class="border">
                                    ...
                                    <tr class="border">
                                        ...
                                        <td class="border text-center">Topics</td>
                                        <td class="border text-center">Subject name</td>
                                        <td class="border text-center">Hard</td>
                                        <td class="border text-center">80</td>
                                        <td class="text-center"><button type="button"
                                                class="btn btn-primary radius-30 ">Details</button></td>
                                        <td class="border">
                                            <div class="d-flex order-actions justify-content-center">
