    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="breadcrumb-title border-0">Add Subject</div>
                <!-- </div> -->
                <!--end breadcrumb-->
                        ...
                        <form id="addSubject">
                            ...
                            <div class="d-lg-flex align-items-center gap-3 mb-3">
                                ...
                                <button type="submit" class="rounded-pill px-4 py-1 border-0"
                                    style="background-color:#0d6dfdd0; color: #fff; font-weight: bold;">ADD</button>
                        ...
                        <div class="">
                            <table class="table " style="width:100% ;">
                                <thead class="table-light border">
                                    <tr class="border">
                                        <th class="border text-center">S/L</th>

                                        <th style="width:70%;height:auto ;" class="text-center"> Subjects List</th>
                                    ...
                                    @if (count($subjects) > 0)
                                        ...
                                        @foreach ($subjects as $key => $subject)
                                            <tr class="border">
                                                ...
                                                <td class="border text-center">{{ $subject->subject }}</td>

                                                <td class="border">
                                                    <div class="d-flex order-actions justify-content-center">
                                                        <a data-id="{{ $subject->id }}"
                                                            data-subject="{{ $subject->subject }}" class="editButton"
                                                            data-toggle="modal" data-target="#editModal"><i
                                                                class='bx bxs-edit'></i></a>
                                                        <a data-id="{{ $subject->id }}" class="ms-3 deleteButton"
